    ...
    <div class="cms-content-fields center ui-widget-content cms-panel-padded fill-height flexbox-area-grow" data-layout-type="border">
        <div class="cms-content-view">
            ...
            <p class="nr-data-provider">
                <%t WebbuildersGroup\\NewRelic\\Control\\Admin\\NewRelicPerformanceReport.DATA_PROVIDED_BY "_Data provided by:" %> <a href="https://www.newrelic.com/" target="_blank"><img src="$resourceURL('webbuilders-group/silverstripe-new-relic: images/new-relic-full.png')" alt="New Relic"/></a>
                <br />
